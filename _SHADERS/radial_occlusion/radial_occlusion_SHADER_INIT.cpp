...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        "     TexCoord1 = vTexCoord + offset1 * 0.00001;                                                                         \n"
      
        "     TexCoord2 = vTexCoord + offset2 * 0.00001;                                                                         \n"
       
        "     TexCoord3 = vTexCoord + offset3 * 0.00001;                                                                         \n"

        "     TexCoord4 = vTexCoord + offset4 * 0.00001;                                                                         \n"
...
"    originalPixel           =  vec4(pow(originalPixel.x * NdotN1 * distance * 250.0, .5));                                            \n"



"    gl_FragColor            =  (originalPixel*-1.0)+1.0;                                                                         \n"
